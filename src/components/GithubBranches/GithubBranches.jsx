...
const GithubBranches = ({ username, repoName }) => {
  ...
  return (
    <div className={`card-insights-branches ${theme}`}>
      <h4 className={`title-insights-branches ${theme}`}>Branches</h4>
      <div className="row">
      ...
      <div className="row">
        <div className="col text-center">
          <h3 className={`number-insights-branches ${theme}`}>
            {branches.length}
          </h3>
        </div>
      </div>
